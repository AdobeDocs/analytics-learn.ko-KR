...
### Analytics Workspace를 사용하여 구매 의도 신호 식별
...
방문자가 우리 사이트에 없으므로 &quot;고객으로 유지할 수 있도록&quot; &quot;유지&quot;는 이 방문 의도에 대해 약간 어색한 이름입니다. 유지는 그 방문에 대한 우리의 의도입니다. 고객에게 공감하고 고객 우선 목표를 유지하는 것을 잊지 마십시오!

### Analytics Workspace를 사용하여 유지 의도 신호 식별

Analytics Workspace 를 사용하면 유지 의도를 식별할 수 있습니다. 페이지, 사이트 섹션 또는 사용자 지정 세그먼트 차원을 사용하여 페이지를 분류할 수 있습니다. 구매 전환율이 낮은 페이지를 찾습니다. 이 예제에서는 온라인 체크인 및 쇼렉스(Shorex) 페이지의 전환율이 쇼핑 및 구매와 논리적으로 연결된 다른 페이지보다 상대적으로 낮습니다.
