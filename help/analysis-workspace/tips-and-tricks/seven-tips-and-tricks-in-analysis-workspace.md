...
>[!TIP]
>
>**많이 요청된 기능:** 당사 고객은 시각화 및 패널을 복사하고 삽입하기 쉽도록 해달라고 요청했습니다. 이제 고객은 기존의 인사이트를 다시 구축하는 데 더 적은 시간을 소비하고, 새로운 인사이트를 발견하는 데 더 많은 시간을 할애합니다.
...
[Experience League에 대한 추가 팁과 요령을 찾으려면 여기를 클릭하십시오.](https://experienceleague.adobe.com/ko?search=tips&tag=Analysis+Workspace#recommended/solutions/analytics)

| 작성자 정보 |            |
|------------|------------|
| ![Jen Lasser](assets/jlasser-headshot-s.jpg) | Jen Lasser는 Adobe Analytics 제품 관리 팀의 관리자입니다. <br> 이 역할에서 그녀는 고객과 대면하여 그들의 비즈니스 요구 사항을 이해하고, <br>배운 내용을 활용하여 Adobe Analytics 제품 로드맵 <br>을(를) 알리고, 새 제품 기능의 우선 순위를 결정합니다. 현재 위치 이전에 <br>Jen은 Adobe 컨설팅 팀의 수석 컨설턴트였으며, 데이터 시각화, Analysis Workspace 및 [!DNL Report Builder]에서 <br>주제 전문가로 일했습니다. <br><br>그녀의 실제 인사이트를 바탕으로 <br>Analysis Workspace 프로젝트를 더 쉽게 구축하고, 시각화하고, 공유할 수 있도록 다음과 같은 팁 및 요령이 선별되었습니다. |
