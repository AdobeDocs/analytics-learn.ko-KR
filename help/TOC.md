...
+ Analytics 소개 {#intro-to-analytics}
   + Adobe Analytics을 통해 얻을 수 있는 이점{#what-can-aa-do-for-me}
      + [Analysis Workspace Adobe을 통한 비즈니스 혁신](intro-to-analytics/what-can-aa-do-for-me/how-adobe-analysis-workspace-can-change-your-business.md)
      + [데이터 그 이상입니다. 고객 인텔리전스](intro-to-analytics/what-can-aa-do-for-me/adobe-analytics-customer-intelligence.md)입니다.
      ...
      + [고객 사례 - The Home Depot](intro-to-analytics/what-can-aa-do-for-me/the-home-depot-innovates-with-customer-experience-management.md)
   ...
   + UI {#customizing-the-ui} 사용자 정의
      ...
      + [Reports and Analytics에서 메뉴 사용자 정의](intro-to-analytics/customizing-the-ui/customizing-the-menu-in-reports-and-analytics.md)
      + [Adobe Analytics의 보안 향상](intro-to-analytics/customizing-the-ui/enhancing-security.md)
   ...
   + 도움말 보기 {#getting-help}
      ...
      + [Adobe Analytics 도움말 보기](intro-to-analytics/getting-help/getting-help.md)
+ Analysis Workspace {#analysis-workspace}
   + Analysis Workspace 기본 사항 {#analysis-workspace-basics}
      ...
      + [Analysis Workspace 프로젝트에 데이터를 통합하는 방법 이해](analysis-workspace/analysis-workspace-basics/understanding-how-data-gets-into-your-analysis-workspace-project.md)
   ...
   + 패널 사용 {#using-panels}
      ...
      + [세그먼트 드롭 영역 개선 사항](analysis-workspace/using-panels/segment-dropzone-improvements.md)
      + [Analysis Workspace의 여러 보고서 세트](analysis-workspace/using-panels/multiple-report-suites-in-analysis-workspace.md)
   + 자유 형식 테이블 만들기 {#building-freeform-tables}
      ...
      + [Analysis Workspace에서 메뉴를 마우스 오른쪽 단추로 클릭합니다.](analysis-workspace/building-freeform-tables/continued-right-click-menu-in-analysis-workspace.md)
      + [Analysis Workspace의 크로스셀 분석](analysis-workspace/building-freeform-tables/cross-sell-analysis-workspace.md)
   ...
   + 시각화 {#visualizations}
      ...
      + [라인 시각화에 트렌드 라인 추가](analysis-workspace/visualizations/adding-trendlines-to-line-visualizations.md)
      ...
      + [요약 번호 및 요약 변경 사항 시각화](analysis-workspace/visualizations/summary-number-and-summary-change-visualizations.md)
      ...
      + [Analysis Workspace의 인트라 링크](analysis-workspace/visualizations/intra-linking-in-analysis-workspace.md)
   ...
   + 고객 여정 분석 중 {#analyzing-customer-journeys}
      ...
      + [흐름 시각화에서 확장](analysis-workspace/analyzing-customer-journeys/expanding-on-flow-visualization.md)
      + [텍스트 감싸기 및 다차원 흐름](analysis-workspace/analyzing-customer-journeys/text-wrapping-and-multi-dimensional-flow.md)
   + 프로젝트 조정 및 공유 {#curate-and-share-projects}
      ...
      + [프로젝트에 대한 직접 링크](analysis-workspace/curate-and-share-projects/direct-link-to-a-project.md)
   ...
   + 집단 분석 {#cohort-analysis}
      ...
      + [집단 테이블을 사용한 가입/해지 전환 분석](analysis-workspace/cohort-analysis/churn-analysis-with-cohort-tables.md)
      + [Dimension을 사용한 집단 분석](analysis-workspace/cohort-analysis/cohort-analysis-using-any-dimension.md)
      + [집단 테이블을 사용한 지연 분석](analysis-workspace/cohort-analysis/latency-analysis-with-cohort-tables.md)
      + [집단 테이블에서 롤링 유지 계산](analysis-workspace/cohort-analysis/calculate-rolling-retention-in-cohort-tables.md)
...
+ 구현 {#implementation}
   + 구현 기본 사항 {#implementation-basics}
      ...
      + [비즈니스 요구 사항 문서 만들기](implementation/implementation-basics/creating-a-business-requirements-document.md)
   ...
   + Experience Platform Launch {#via-adobe-launch} 사용
      ...
      + [Analytics 시작 확장 기본 구성](implementation/via-adobe-launch/basic-configuration-of-the-analytics-launch-extension.md)
      ...
      + [Launch Analytics Extension의 일반 설정 구성](implementation/via-adobe-launch/configuring-general-settings-in-the-launch-analytics-extension.md)
      ...
      + [Experience Platform Launch에서 글로벌 페이지 규칙 만들기](implementation/via-adobe-launch/creating-a-global-page-rule-in-launch.md)
   ...
   + {#validating-and-troubleshooting} 유효성 확인 및 문제 해결
      ...
      + [Experience Cloud Debugger으로 사후 처리된 히트 보기](implementation/validating-and-troubleshooting/view-post-processed-hits-with-the-experience-cloud-debugger.md)
   + SPA 페이지 {#spa-pages}
...
+ 구성 요소 {#components}
   + 세그먼테이션 {#segmentation}
      ...
      + [순차적 세그멘테이션의 시퀀스 이전/후](components/segmentation/before-after-sequences-in-sequential-segmentation.md)
      ...
      + [세그멘테이션의 연산자 중 하나와 같음](components/segmentation/equals-any-of-operator-in-segmentation.md)
   + 계산된 지표 {#calculated-metrics}
      + [계산된 지표의 고유 함수 대략적인 계산](components/calculated-metrics/approximate-count-distinct-function-in-calculated-metrics.md)
      + [계산된 지표의 Attribution IQ](analysis-workspace/attribution-iq/attribution-iq-in-calculated-metrics.md)
...
+ 추가 도구 {#additional-tools}
   + 분석 대시보드 {#analytics-dashboards}
      ...
      + [분석 대시보드 인앱 경험](additional-tools/analytics-dashboards/adobe-analytics-dashboards-in-app-experience.md)
+ {#exporting} 내보내기
   + UI {#from-the-ui}에서
      + [Analysis Workspace에서 CSV로 내보내기](exporting/from-the-ui/export-to-csv-from-analysis-workspace.md)
   ...
   + Report Builder {#report-builder}
      ...
      + [전체 요청에서 지표 편집](exporting/report-builder/edit-metrics-across-requests.md)
...
+ 통합 {#integrations}
   ...
   + Ad Cloud {#ad-cloud}
      ...
      + [사전 시작 캠페인 분석 만들기](integrations/ad-cloud/create-a-pre-launch-campaign-analysis-with-adobe-analytics.md)
      ...
      + [Advertising Cloud 사이트 시작 보고서 만들기](integrations/ad-cloud/create-advertising-cloud-site-entry-reports.md)
...
+ 데이터 과학 {#data-science}
   ...
   + [Adobe Analytics 및 Adobe Sensei - 모든 사용자를 위한 데이터 과학 통합](data-science/adobe-analytics-and-adobe-sensei-democratizing-data-science-for-all.md)
+ 수직 전용 {#vertical-specific}
   + 하이테크 {#high-tech}
      + [Summit 2019 Super Session - 첨단 기술](intro-to-analytics/what-can-aa-do-for-me/adobe-summit-2019-super-session-high-tech.md)
   ...
   + 소매 {#retail}
      ...
      + [구매 이벤트에 대한 시작 규칙 추가](vertical-specific/retail/adding-a-launch-rule-for-the-purchase-event.md)
      + [Summit 2019 Super Session - 소매](intro-to-analytics/what-can-aa-do-for-me/adobe-summit-2019-super-session-retail.md)
...
+ 모바일 앱 분석 {#mobile-app-analytics}
   + 구현 {#implementation}
      ...
      + [추적 작업(사용자 지정 링크)](mobile-app-analytics/implementation/tracking-actions-aka-custom-links.md)
