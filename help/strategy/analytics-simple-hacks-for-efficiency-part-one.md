...
1. 데이터 수집 문서 및 거버넌스 - 기술 사양:
   ...
   기술 사양은 SDR보다 제한된 대상자를 보유하고 있지만 완전한 기능 구현을 위해서는 그 이상은 아니더라도 그만큼 중요합니다. 좋은 기술 사양에는 솔루션을 구현하는 데 필요한 모든 개발, QA 및 태그 관리 리소스가 포함되어야 합니다. 고유한 구현 아키텍처를 수용하는 데 필요한 만큼의 문서를 유지 관리해야 합니다.

   **기술 사양**

   데이터 수집을 위한 스크립트를 구성하는 방법을 설명하는 지침(_U):_
...
1. 데이터 수집 문서, 거버넌스 및 데이터 위생 - AHD:
   ...
   단일 보고서 세트에 의해 캡처되는 모든 지표 및 차원의 사용 사례&#x200B;:_스냅숏(_U)

   기본 사용자&#x200B;:_리드 분석 SME 및/또는 개발자(_C)
