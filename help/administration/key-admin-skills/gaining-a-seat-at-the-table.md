...
“테이블의 자리 얻기.” 이 인기 구문은 지금까지 수년 동안 업계에서 많은 관심을 받고 있는 주제입니다. 하지만 어떤 의미일까요? 테이블의 자리 얻기는 높은 수준의 의사 결정 대화에 함께 한다는 의미입니다. 귀하만 초대 받는 것은 아니지만 귀하의 조언이 가치를 인정 받게 됩니다. 테이블 자리를 확보하면 귀사와 Adobe Analytics 고급 사용자로서 귀사의 경력에 어떤 도움이 될지, 귀사의 공식 역할이 관리자, 데이터 분석가, 또는 본인의 명함이 어떻게 다른지 보여드리겠습니다.

## 왜 테이블에 있어야 하는가

먼저, 방해가 되는 것들을 치우겠습니다. 데이터 전문가의 역할이 진화했습니다. eVar, 이벤트 및 sProp에만 초점을 맞추어 더 이상 컴퓨터 화면 뒤에 앉을 수 없습니다. 관리자로서 회사가 정확하게 데이터 기반의 결정을 하고 있는지 확인할 의무가 있습니다. 하지만 이를 위해 책상에 앉아 숫자만 계산하는 대신 결정이 이루어지는 현장에 있어야 합니다.
